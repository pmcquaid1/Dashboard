# Generated by Django 5.1.2 on 2025-03-17 20:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_view_page', 'View Page'), ('can_view_page_ops', 'View Ops Page'), ('can_view_page_finance', 'View Finance Page'), ('can_view_page_qhse', 'View QHSE Page'), ('can_view_page_hr', 'View HR Page')],
            },
        ),
        migrations.CreateModel(
            name='FuelReq',
            fields=[
                ...
                ('initial_tank_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('top_up_quantity', models.DecimalField(decimal_places=2, max_digits=10)),
